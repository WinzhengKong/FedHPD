...
file_names = [file for file in os.listdir() if file.startswith('rewards_per_agent_Lunar_Black_10_80')]
...
for agent_number in range(1, 11):
    ...
    # 保存平均值到csv文件
    output_file_name = f'KD_Black_Box_10_KDper80_Agent{agent_number}.csv'
