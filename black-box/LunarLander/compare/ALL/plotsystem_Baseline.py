...
def plot_comparison(num_agents, window_size=50):
    ...
    filenames_category_2 = [f'KD_Black_Box_DPAFedRL_Lunar_Agent{i}.csv' for i in range(1, num_agents + 1)]
    ...
    filenames_category_5 = [f'KD_Black_Box_10_KDper20_Agent{i}.csv' for i in range(1, num_agents + 1)]  # New category
    ...
    output_filename = f'Rewards_LunarLander_system_baseline.png'
