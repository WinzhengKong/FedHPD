...
def plot_comparison(num_agents, window_size=50):
    ...
    filenames_category_2 = [f'KD_Black_Box_10_KDper2_Agent{i}.csv' for i in range(1, num_agents + 1)]
    filenames_category_3 = [f'KD_Black_Box_SL_10_0827_Agent{i}.csv' for i in range(1, num_agents + 1)]
    filenames_category_4 = [f'KD_Black_Box_10_KDper10_Agent{i}.csv' for i in range(1, num_agents + 1)]
    filenames_category_5 = [f'KD_Black_Box_10_KDper20_Agent{i}.csv' for i in range(1, num_agents + 1)]
    filenames_category_6 = [f'KD_Black_Box_10_KDper40_Agent{i}.csv' for i in range(1, num_agents + 1)]
    filenames_category_7 = [f'KD_Black_Box_10_KDper80_Agent{i}.csv' for i in range(1, num_agents + 1)]
    ...
    output_filename = f'Rewards_Lunar_system_d_explore.png'
