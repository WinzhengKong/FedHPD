...
def plot_agent_rewards(agent_number, window_size=50):
    ...
    filenames = [
        f'Lunar_NoFed_Agent{agent_number}.csv',
        f'KD_Black_Box_SL_Agent{agent_number}.csv',
        f'KD_Black_Box_SLW_Agent{agent_number}.csv'  # Add the new category
    ]
...
def plot_all_agents(num_agents, window_size=50):
    # Set figure size
    fig_width, fig_height = 24, 10  # Adjusted for additional category
    ...
    labels = ['WoFed', 'FedBPG', 'NewMethod']  # Update labels for three categories
    ...
    for i in range(1, num_agents + 1):
        ...
        ax.set_ylim(-200, 250)  # Set y-axis range
