...
def plot_comparison(num_agents, window_size=50):
    filenames_category_1 = [f'KD_Black_Box_WoFed_10_0828_Agent{i}.csv' for i in range(1, num_agents + 1)]
    filenames_category_2 = [f'KD_Black_Box_SL_10_0827_Agent{i}.csv' for i in range(1, num_agents + 1)]
    filenames_category_3 = [f'KD_Black_Box_10_KDper10_Agent{i}.csv' for i in range(1, num_agents + 1)]
    filenames_category_4 = [f'KD_Black_Box_10_KDper20_Agent{i}.csv' for i in range(1, num_agents + 1)]
    ...
    output_filename = f'Rewards_LunarLander_system.png'
