...
def main(seed, episodes, distill_interval):
    ...
    # Server Agent setup
    server_env = gym.make('CartPole-v1')
    ...
    rewards_filename = f'rewards_per_agent_Black_Box_SL_10_{distill_interval}_{timestamp}.csv'
    ...
    average_rewards_filename = f'rewards_Black_Box_SL_10_{distill_interval}_{timestamp}.csv'
