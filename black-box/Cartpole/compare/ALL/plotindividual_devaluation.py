...
def plot_agent_rewards(agent_number, window_size=50):
    ...
    filenames = [
        ...
        f'KD_Black_Box_SL_10_KDper2_Agent{agent_number}.csv',
        ...
        f'KD_Black_Box_SL_10_KDper40_Agent{agent_number}.csv',  # New sixth category
        f'KD_Black_Box_SL_10_KDper80_Agent{agent_number}.csv'  # New seventh category
    ]
...
def plot_all_agents(num_agents, window_size=50, save_to_file=False):
    ...
    if save_to_file:
        ...
        output_filename = f'Rewards_Cartpole_dexplore.png'
