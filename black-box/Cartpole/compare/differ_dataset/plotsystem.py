...
def plot_comparison(num_agents, window_size=50):
    ...
    filenames_category_3 = [f'KD_Black_Box_SL_10_data5f5_Agent{i}.csv' for i in range(1, num_agents + 1)]
    filenames_category_4 = [f'KD_Black_Box_SL_10_data1f1_Agent{i}.csv' for i in range(1, num_agents + 1)]
    ...
    labels = ['NoFed', 'Dataset 1', 'Dataset 2', 'Dataset 3']
    ...
    output_filename = f'Rewards_Cartpole_system_dataset.png'
