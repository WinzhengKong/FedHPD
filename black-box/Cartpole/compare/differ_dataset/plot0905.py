...
def plot_agent_rewards(agent_number, window_size=50):
    ...
    filenames = [
        ...
        f'KD_Black_Box_SL_10_data5f5_Agent{agent_number}.csv',
        f'KD_Black_Box_SL_10_data1f1_Agent{agent_number}.csv'  # New fourth category
    ]
...
def plot_all_agents(num_agents, window_size=50, save_to_file=False):
    ...
    labels = ['NoFed', 'Dataset 1', 'Dataset 2', 'Dataset 3']  # Updated labels for four categories
    ...
    if save_to_file:
        ...
        output_filename = f'Rewards_Cartpole_differ_dataset_10.png'
